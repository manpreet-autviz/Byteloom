...
export class InsightsComponent {
  ...
  originalData: any;
  // Array to keep track of expanded nodes for each TAT value
  expandedNodesMap: { [key: string]: any[] } = {};
  constructor(
  ...
  ngOnInit() {
    ...
    if (this.finalData.length > 0) {
      this.finalData[0].expanded = true;
      this.cdRef.detectChanges();
    }
    if (this.loginData.length > 0) {
      this.loginData[0].expanded = true;
      this.cdRef.detectChanges();
    }
    if (this.financialData.length > 0) {
      this.financialData[0].expanded = true;
      this.cdRef.detectChanges();
    }
