        ...
        tooltip: {
          ...
          formatter: (params: any) => {
            ...
            if (params.name === 'BT') {
              ...
              tooltipText = 'No. of files: 900 <br/> Amount in Cr: 65'  ;
  
            } else if (params.name === 'Top-Up') {
  
              tooltipText = 'No. of files: 630 <br/> Amount in Cr: 15' ;
  
            } else if (params.name === 'Fresh') {
  
              tooltipText = 'No. of files: 720 <br/> Amount in Cr: 20' ;
        ...
        tooltip: {
          ...
          formatter: (params: any) => {
            ...
            if (params.name === 'HL') {
              ...
              tooltipText = 'No. of files: 900 <br/> Amount in Cr: 60'  ;
  
            } else if (params.name === 'LAP') {
  
              tooltipText = 'No. of files: 630 <br/> Amount in Cr: 12' ;
  
            } else if (params.name === 'BL') {
  
              tooltipText = 'No. of files: 720 <br/> Amount in Cr: 8' ;
  
            } else if (params.name === 'SBL') {
  
              tooltipText = 'No. of files: 810 <br/> Amount in Cr: 20' ;
